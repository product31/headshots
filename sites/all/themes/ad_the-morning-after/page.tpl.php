...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header-image">
      ...
      if ($is_front) {print '<div class="breadcrumb">// ' . t('Home') . '</div>';} else { echo '<div class="breadcrumb">' . str_replace(t('Home'), '', str_replace('</div>', '', $breadcrumb3)) . ' // ' . $title . '</div>' ;} ?>
    </div>
    ...
    <div style="float:right;"><a href="http://www.avioso.com">Theme port</a> sponsored by <a href="http://www.duplika.com">Duplika Hosting</a>.</div>
    <span class="clear"></span>
